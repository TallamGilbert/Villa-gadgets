  ...
  if (success) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
        <div className="bg-white p-8 rounded-2xl border shadow-sm w-full max-w-sm text-center space-y-4">
          <div className="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto">
            <svg className="w-8 h-8 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
            </svg>
          </div>
          <h2 className="text-xl font-black text-[#0A2540]">Check your email</h2>
          <p className="text-sm text-gray-500">
            We sent a confirmation link to <strong>{email}</strong>. Click it to activate your account.
          </p>
          <button
            onClick={() => navigate("/login")}
            className="w-full bg-[#0A2540] text-white p-3 rounded-lg font-bold"
          >
            Back to Login
          </button>
        </div>
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="bg-white p-8 rounded-2xl border shadow-sm w-full max-w-sm space-y-5">
        <div>
          <h2 className="text-xl font-black text-[#0A2540]">Create account</h2>
          <p className="text-sm text-gray-400 mt-1">Join Villa Gadgets today</p>
        </div>
        ...
        <p className="text-center text-sm text-gray-500">
          ...
          <Link to="/login" className="text-[#0A2540] font-bold hover:underline">
            Sign in
          </Link>
        </p>
      </div>
